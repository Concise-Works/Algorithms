...
\begin{Example}[Functionally Complete Sets of Operators]
  ...
  \label{ex:functionally_complete_sets}
...
\begin{figure}[ht!]
  ...
  \caption{Both inputs are (1,0), PUN half-closed reaching the output, PDN half-closed, but can't reach ground; Hence the output is high (1).}
  \label{fig:nand-3}
\end{figure}
...
\begin{figure}[ht!]
  ...
  \caption{Both inputs are (1,1), PUN fully closed, PDN open grounding the output to (0).}
  \label{fig:nand-4}
\end{figure}
\\
...
\begin{Note}
\textbf{Note:} Since PUNs are by default high, other functions may not be as straightforward, requiring 
  us to invert or adjust our logic to achieve the desired output.
\end{Note}
