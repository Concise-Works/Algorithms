...
\begin{theo}[Glitches from Ipmlicant Hopping]

  Jumping between two prime implicants which do not overlap causes glitches.
  This is because each implicant, i.e., product term, is responsible for driving the output.
  So when we hop these regions, the output briefly has undefined behavior, due to the $t_{PD}$ (uncertainty period).
\end{theo}