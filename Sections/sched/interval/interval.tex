...
\begin{figure}[h]
    \begin{center}
      \includegraphics[width=1\textwidth]{./Sections/sched/interval/interval.png}
    \end{center}
...
\begin{Proof}[Greedy Algorithm Earliest Finish Time Correctness]
   ...
   \begin{figure}[h]
    \begin{center}
      \includegraphics[width=1\textwidth]{./Sections/sched/interval/interval_proof.png}
    \end{center}

     \vspace{-1em}
     \caption{At the first divergence, $i_{r+1}$, it is interchangeable with $j_{r+1}$ (the optimal solution's choice);
     As if we were to cut the function $f$ off at this moment, $f_{i_{r+1}} \leq f_{j_{r+1}}$. Hence, by induction,
     if we were to keep doing this, our greedy solution remains optimal (same number of jobs).}\label{fig:interval_proof}
\end{figure}
...
\begin{figure}[h]
    \begin{center}
      \includegraphics[width=1\textwidth]{./Sections/sched/interval/interval_sol.png}
    \end{center}
...
\begin{figure}[h]
    \begin{center}
      \includegraphics[width=1\textwidth]{./Sections/sched/interval/part/class_4.png}
    \end{center}
