...
\begin{figure}[h]
\centering
\includegraphics[width=1\textwidth]{Sections/dp/wis.png}
\end{figure}
...
\end{Def}   
    ...
    \begin{figure}[h]
        ...
        \includegraphics[width=.85\textwidth]{Sections/dp/knapsack.png}

        \caption{A filled knapsack DP table. The red arrows indicate backtracking. We see when 
        item 4 is removed, we jump to 18, indicating that item 4 was used in the optimal solution, and so forth.}
    \end{figure}
    \label{fig:knapsack}
