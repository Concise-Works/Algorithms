...
work at BU for Computer Science. I would go onto retake classes CS131 (Discrete Math), CS210 (Computer Systems),
...
that motivated our modern system today.
...
\noindent 
\textbf{Support:} If you want to support, give a star on github (\url{https://github.com/Concise-Works/Algorithms}), share with your friends!\\
\textbf{Contribute:} If you find an error, want to add something, or revise anything, consider forking and contributing, via the 
above link. Pull requests are welcome! Submit practice problems, engage with the text, take ownership of your learning. 
