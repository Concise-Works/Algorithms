...
\begin{figure}[h]
    \begin{center}
      \includegraphics[height=1.6in]{./Sections/graphs/dag/dag.png}
    \end{center}
...
\begin{figure}[h]
    \begin{center}
      \includegraphics[height=1.6in]{./Sections/graphs/dag/top.png}
    \end{center}
...
\begin{figure}[h]
    \begin{center}
      \includegraphics[width=1\textwidth]{./Sections/graphs/dag/top_sort.png}
    \end{center}
     \caption{A topological sorting of a DAG $E$ and $v_i$ nodes}\label{fig:top_sort}
\end{figure} 
...
\begin{Def}[Strongly Connected Components]
    ...
    A \textbf{strongly connected component} (SCC) is a subgraph where every node is reachable from every other node. 
