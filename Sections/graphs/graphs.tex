...
\begin{figure}[h]
  \begin{center}
    \includegraphics[width=.7\textwidth]{./Sections/graphs/adj_matrix.png}
  \end{center}
...
\begin{theo}[Properties of Adjacency Matrix]
  ...
  The following properties hold for adjacency matrices:
        An \textbf{undirected graph} \underline{is symmetric} about the diagonal.
        A \textbf{directed graph} \underline{is not} symmetric about.
        A \textbf{weighted graph} has the weight of the edge in each cell instead of 0s and 1s (0 being no edge).\\
...
\begin{figure}[h]
  \begin{center}
    \includegraphics[width=.7\textwidth]{./Sections/graphs/adj_matrix_dir.png}
  \end{center}
